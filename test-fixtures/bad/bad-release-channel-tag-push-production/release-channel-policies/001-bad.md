...
| Recommendation | REQUIRE_RELEASE_OWNER_DECISION |
| Blocked | Yes |
...
| Source ref role | release_trigger |
| Git allowed | Yes |
...
| Identity ref | external:deploy |
| Digest or ID | deploy-1 |
...
```json
{
  ...
  "release_channel_policy_digest": "sha256:3e96c92e69034e7ed2c3bccfeb01a666dc704c5dc587689ee0b4c837b3dea312",
  ...
  "source_identity": {
    ...
    "source_ref_role": "release_trigger",
    "git_allowed": "Yes",
    "tag_allowed_as_identity": "Yes",
    "tag_used": "Yes",
    "tag_triggers_release_workflow": "Yes",
    "tag_trigger_workflow_ref": "file:.github/workflows/release.yml"
  },
  "effective_release_channel": {
    "channel": "provider_direct_deploy",
    "recommendation_class": "REQUIRE_RELEASE_OWNER_DECISION",
    "blocked": "Yes",
    "blocked_by": [
    ...
    "recommended_channel_summary": "provider_direct_deploy with recommendation REQUIRE_RELEASE_OWNER_DECISION."
  },
  ...
  "release_package_identity": {
    ...
    "identity_ref": "external:deploy",
    "digest_or_id": "deploy-1",
