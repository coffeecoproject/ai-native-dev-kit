...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R-001` | `AGENTS.md` | line 2: Old workflow rule. | `WORKFLOW_RULE` | old agent rule | replace after reviewed plan and approval | replace | Workflow rule can move to IntentOS. | workflow | replace with IntentOS rule | Yes |
...
| --- | --- | --- | --- | --- | --- |
| 1 | approves implementation after migration | `src/feature.ts` | No | Yes | Proposed |
...
- This plan approves implementation: Yes
