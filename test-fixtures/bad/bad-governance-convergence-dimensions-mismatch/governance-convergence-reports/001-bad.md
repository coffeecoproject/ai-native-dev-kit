...
```json
{
  ...
  "dimensions": [
    ...
    { "dimension": "baseline", "current_state": "Web engineering baseline exists", "target_state": "Best available baseline rule", "recommendation": "MERGE_AFTER_REVIEW", "human_decision_required": "Yes", "write_requires_apply_plan": "Yes" },
