...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R-001` | `AGENTS.md` | line 4: Customer cancellation window is 24 hours. | `BUSINESS_FACT` | project owner | preserve or escalate | preserve | Business rule is project-owned. | business | preserve as project constraint | Yes |

## Conflicts And Decisions

| Conflict ID | Conflict Type | Existing Source | IntentOS Target | Default Decision | Human Decision Required |
| --- | --- | --- | --- | --- | --- |
| `C-001` | `BUSINESS_CONFLICT` | `AGENTS.md` | IntentOS migration | Do not remove business rule | Yes |

## Proposed Native Migration Plan

| Step | Action | Exact Target Path | Writes Target Files? | Requires Human Approval | Status |
| --- | --- | --- | --- | --- | --- |
| 1 | Removes business constraint from AGENTS.md | `AGENTS.md` | No | Yes | Proposed |
...
| Item | Action | Reason |
| --- | --- | --- |
| Business rule | Remove | Bad fixture |
