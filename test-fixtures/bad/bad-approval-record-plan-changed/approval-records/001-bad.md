# Approval Record: bad plan changed after approval
...
| Plan hash | `sha256:7777777777777777777777777777777777777777777777777777777777777777` |
| Plan changed after approval | Yes |

## Approved Action IDs

| Action ID | Action type | Target paths | Approved? | Notes |
|---|---|---|---|---|
| A001 | WORKFLOW_ASSET_UPDATE | `.ai-native/version.json` | Yes | plan changed |
