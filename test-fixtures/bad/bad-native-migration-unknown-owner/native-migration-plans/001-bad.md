...
| --- | --- | --- |
| Agent rules | `AGENTS.md` | owner unknown |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R-001` | `AGENTS.md` | line 2: Unknown rule source. | `UNKNOWN_AUTHORITY` | unknown | stop for classification | preserve until classified | Owner is unknown. | workflow | apply migration now | Yes |

## Conflicts And Decisions

| Conflict ID | Conflict Type | Existing Source | IntentOS Target | Default Decision | Human Decision Required |
| --- | --- | --- | --- | --- | --- |
| `C-001` | `OWNER_CONFLICT` | `AGENTS.md` | Native migration | Stop until owner classifies rule | Yes |

## Proposed Native Migration Plan

| Step | Action | Exact Target Path | Writes Target Files? | Requires Human Approval | Status |
| --- | --- | --- | --- | --- | --- |
| 1 | Continue migration despite unknown owner | `AGENTS.md` | No | Yes | Proposed |
...
| Item | Action | Reason |
| --- | --- | --- |
| Unknown rule | Replace | Bad fixture |
