# Subagent Run Plan: bad idle running

## Human Summary

One-sentence conclusion:

Dispatch is incorrectly allowed while an idle helper has not been recovered.

## Goal

Goal: demonstrate invalid dispatch with idle helper not recovered.
...
|---|---|---|---|---|---|---|
| A1 | Reviewer | READ_ONLY | CLOSED | none | findings handed off | Review summary recorded |
...
Dispatch block reason: ignored idle helper

Recovery notes: idle helper remains.
...
|---|---|---|---|
| A1 | findings | Review Loop | Closed |
...
Next action: should not dispatch.
