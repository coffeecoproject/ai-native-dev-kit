...
Why: This incorrectly assigns production deploy to Codex.
...
| Human Release Approval | `PASS` | approval-records/001-release.md | Approved. |
...
| Why | Incorrect high-risk assignment. |

## Execution Steps

| Step | Type | Executor | Status | Evidence Required | Stop Condition |
|---|---|---|---|---|---|
| Production deploy | `DEPLOY_OR_SUBMIT` | `CODEX_MAY_RUN_AFTER_APPROVAL` | `PENDING` | Production deployment evidence | Stop before production action. |
