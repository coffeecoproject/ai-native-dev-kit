...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R-001` | AGENTS.md | 5-7 | root | Workflow, business, and production rules are all migrated together. | `WORKFLOW_RULE` | old workflow source | replace after reviewed plan and approval | replace | Collapsed mixed authority into one workflow row. | workflow | replace with IntentOS workflow rule through apply-plan | Yes | HIGH |
...
```json
{
  ...
  "rule_extraction_coverage": [
    {"source_file": "AGENTS.md", "lines_scanned": 12, "rules_extracted": 3, "unclassified_blocks": [], "parser_warnings": []}
  ],
  "rule_classifications": [
    {
      ...
      "source_start_line": 5,
      "source_end_line": 7,
      "context_heading": "root",
      "source_excerpt": "Workflow, business, and production rules are all migrated together.",
      ...
      "reason": "Collapsed mixed authority into one workflow row.",
