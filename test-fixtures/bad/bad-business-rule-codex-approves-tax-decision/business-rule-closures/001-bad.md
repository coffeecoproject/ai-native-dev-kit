...
customer tax ID is required and tax compliance is approved
...
| `INPUT_CONDITION` | `CLOSED` | customer tax ID is required and tax compliance is approved | human-decision:rule-understanding |
...
```json
{
  ...
  "user_request": "customer tax ID is required and tax compliance is approved",
  ...
  "dimensions": [
    ...
    },
    {
      ...
      "status": "CLOSED",
      "summary": "customer tax ID is required and tax compliance is approved",
      "evidence_refs": [
        "human-decision:rule-understanding"
      ],
      "decision_refs": [],
