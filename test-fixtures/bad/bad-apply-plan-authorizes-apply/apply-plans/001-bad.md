# Unified Apply Plan: bad authorization

## Human Decision Summary

One-sentence conclusion: This bad plan incorrectly authorizes apply.
...
|---|---|---|---|---|---|---|---|
| A-001 | WORKFLOW_ASSET_UPDATE | .ai-native | Bad fixture. | PLAN_ONLY | No | Yes | Yes |
...
|---|---|---|---|---|
| A-001 | Yes | .ai-native/backups/bad/ | Restore backup. | Run check. |
...
- This plan authorizes apply: Yes
