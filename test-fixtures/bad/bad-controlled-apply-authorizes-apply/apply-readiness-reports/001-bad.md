# Controlled Apply Readiness Report: bad authorizes apply
...
|---|---|---|---|
| `WORKFLOW_ASSET_UPDATE` | `.ai-native` | LOW_RISK_CANDIDATE | Safe. |
...
- This readiness report authorizes apply: Yes
