...
| Safe Next Step | Codex is the release owner and can finish release. |

## Release Decision View

| Decision | Status | Reason | Next Step |
|---|---|---|---|
| Final release-plan state | `READY_FOR_PRODUCTION_HANDOFF` | Codex is the release owner. | Proceed. |
...
|---|---|---|---|---|
| Release Guide | `SOURCE_SYSTEM` | `PASS` | N/A | Ready. |
...
| Action | Condition |
|---|---|
| Act as release owner | Codex becomes the release owner. |

## Human Must Decide

| Decision | Why | Next Step |
|---|---|---|
| None | Codex owns it. | Proceed. |

## External System Actions

| Action | Owner |
|---|---|
| Production deploy | Codex |

## Evidence Requirements

| Evidence | Required | Status | Ref |
|---|---|---|---|
| Release approval | Yes | `PASS` | N/A |
...
- This plan makes Codex the release owner: Yes
