...
| --- | --- | --- | --- |
| criterion:demo | `DONE` | `file:evidence/another-task-stale.txt` | Bad fixture. |

## Planned Impact Map

| Surface | Expected | Status | Evidence | Notes |
| --- | --- | --- | --- |
| FRONTEND_UI | `Yes` | `DONE` | `file:evidence/another-task-stale.txt` | Bad fixture. |
...
| --- | --- | --- | --- |
| criterion:demo | `file:evidence/another-task-stale.txt` | `Yes` | `Yes` |
    ...
    "criteria": [
      {
        ...
        "status": "DONE",
        "evidence_refs": [
          "file:evidence/another-task-stale.txt"
        ]
      }
    ]
  },
  ...
  "evidence_bindings": [
    {
      ...
      "evidence_ref": "file:evidence/another-task-stale.txt",
      "resolved": "Yes",
