...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R-001` | AGENTS.md | 5-5 | Workflow Rules | Codex should follow the old task checklist. | `WORKFLOW_RULE` | old workflow source | replace after reviewed plan and approval | replace | Old workflow guidance can move after approval. | workflow | replace with IntentOS workflow rule through apply-plan | Yes | HIGH |
...
| Item | Action | Reason |
| --- | --- | --- |
| Old workflow rules | Replace after approval | IntentOS becomes workflow authority |
...
| Restore method | Restore approved backup or keep old governance unchanged |
| Restore owner | human owner |
...
```json
{
  ...
  "rule_extraction_coverage": [{"source_file": "AGENTS.md", "lines_scanned": 6, "rules_extracted": 1, "unclassified_blocks": [], "parser_warnings": []}],
  "rule_classifications": [{"rule_id": "R-001", "source_file": "AGENTS.md", "source_start_line": 5, "source_end_line": 5, "context_heading": "Workflow Rules", "source_excerpt": "Codex should follow the old task checklist.", "rule_class": "WORKFLOW_RULE", "authority": "old workflow source", "default_handling": "replace after reviewed plan and approval", "preserve_or_replace": "replace", "reason": "Old workflow guidance can move after approval.", "risk_surfaces": "workflow", "target_action": "replace with IntentOS workflow rule through apply-plan", "human_decision_required": "Yes", "confidence": "HIGH"}],
  "proposed_actions": [],
  "authority_transition": {},
  "boundary": {"writesTargetFiles": "No", "authorizesTargetFileWrites": "No", "approvesImplementation": "No", "approvesReleaseOrProduction": "No", "modifiesCiOrHooks": "No"},
