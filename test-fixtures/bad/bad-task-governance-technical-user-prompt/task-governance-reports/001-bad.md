...
| --- | --- |
| Task impact | `HIGH` |
| Plain next step | 是否进入 Business Rule Closure / Change Impact Coverage / Execution Assurance？ |
...
```json
{
  ...
  "task_governance_digest": "sha256:ec800afd1563a068c4d99be9223d7d1c787afca0d61dbe2222fe9ea13bb41fcc",
