...
| --- | --- | --- | --- |
| criterion:demo | `DONE` | `file:evidence/missing-proof.txt` | Bad fixture. |

## Planned Impact Map

| Surface | Expected | Status | Evidence | Notes |
| --- | --- | --- | --- |
| FRONTEND_UI | `Yes` | `DONE` | `file:evidence/missing-proof.txt` | Bad fixture. |
...
| --- | --- | --- | --- |
| criterion:demo | `file:evidence/missing-proof.txt` | `Yes` | `Yes` |
    ...
    "criteria": [
      {
        ...
        "status": "DONE",
        "evidence_refs": [
          "file:evidence/missing-proof.txt"
        ]
      }
    ]
  },
  ...
  "evidence_bindings": [
    {
      ...
      "evidence_ref": "file:evidence/missing-proof.txt",
      "resolved": "Yes",
