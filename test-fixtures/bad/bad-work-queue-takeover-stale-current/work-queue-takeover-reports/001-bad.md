...
| --- | --- | --- | --- |
| TODO.md | MARK_STALE | CURRENT | Use the first viable source as the candidate current task after Task Governance binding. |
...
```json
{
  ...
  "work_queue_takeover_digest": "sha256:90eb937bc11ffca876dcae3c41bfe002e0de390a6bd2df64403efdedf63b0896",
