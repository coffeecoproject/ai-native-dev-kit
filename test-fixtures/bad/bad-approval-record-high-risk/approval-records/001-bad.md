# Approval Record: bad high risk

## Human Decision Summary

Approval status: `APPROVED`

Conclusion: `High-risk action incorrectly approved.`
...
| Plan hash | `sha256:eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee` |
...
|---|---|---|---|---|
| A001 | HOOK_OR_CI_CHANGE | `.github/workflows/intentos-pr-checks.yml` | Yes | bad |

## Approval Scope

| Field | Value |
|---|---|
| Included target paths | `.github/workflows/intentos-pr-checks.yml` |
...
Project owner approves A001 for `.github/workflows/intentos-pr-checks.yml` only.
