...
|---|---|---|---|---|
| A001 | HOOK_OR_CI_CHANGE | `.github/workflows/dev-kit-pr-checks.yml` | Yes | bad |

## Approval Scope

| Field | Value |
|---|---|
| Included target paths | `.github/workflows/dev-kit-pr-checks.yml` |
...
Project owner approves A001 for `.github/workflows/dev-kit-pr-checks.yml` only.
