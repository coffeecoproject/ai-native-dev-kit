...
| Field | Value |
| --- | --- |
| Plain user summary | I found release-channel gaps (missing_cost_owner). I will keep release review blocked and prepare only evidence, not release execution. |
...
| External provider cost risk | Yes |
...
```json
{
  ...
  "release_channel_policy_digest": "sha256:ee3f60ebd025092af04c20895637b07039329d5140ab3bb5623e875017c0296e",
  ...
  "cost_risk": {
    ...
    "external_provider_cost_risk": "Yes",
  ...
  "decision": {
    ...
    "plain_user_summary": "I found release-channel gaps (missing_cost_owner). I will keep release review blocked and prepare only evidence, not release execution."
  },
  "boundaries": {
    "approves_release": "No",
    "executes_release": "No",
