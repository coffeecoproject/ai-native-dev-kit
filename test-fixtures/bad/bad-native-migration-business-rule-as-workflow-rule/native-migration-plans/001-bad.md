...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R-001` | AGENTS.md | line 3: customer contract tax data must be preserved exactly | `WORKFLOW_RULE` | old workflow source | replace after reviewed plan and approval | replace | Treat as old workflow guidance | workflow | replace with IntentOS workflow rule through apply-plan | Yes |
