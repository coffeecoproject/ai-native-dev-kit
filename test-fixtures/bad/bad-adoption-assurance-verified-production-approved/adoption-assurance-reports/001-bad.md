...
The project is production approved by IntentOS.
...
```json
{
  ...
  "source_systems": {},
  "simulation": {"id":"simulation:bad","state":"SIMULATION_PASSED","task":"Bad production claim.","writes_target_files":"No","route":[],"steps":[]},
  "pending_decisions": [],
  "forbidden_claims": [],
