...
| Field | Value |
| --- | --- |
| Plain user summary | I found release-channel gaps (missing_cost_owner, missing_artifact_retention_policy). I will keep release review blocked and prepare only evidence, not release execution. |
...
| Artifact retention policy ref | missing |
| Policy state | BLOCKED_LONG_LIVED_PACKAGE |
...
```json
{
  ...
  "release_channel_policy_digest": "sha256:97e3bd74ffc4445fbc86f22fe36cecb17fa635c65e415cedb81cb07232dcfa7c",
  ...
  "effective_release_channel": {
    ...
    "blocked_by": [
      "missing_cost_owner",
      "missing_artifact_retention_policy"
    ],
  ...
  "github_actions_policy": {
    ...
    "artifact_retention_policy_ref": "missing",
    "policy_state": "BLOCKED_LONG_LIVED_PACKAGE"
  },
  ...
  "decision": {
    ...
    "needs_cost_owner_decision": "Yes",
    "blocks_release_review": "Yes",
    "plain_user_summary": "I found release-channel gaps (missing_cost_owner, missing_artifact_retention_policy). I will keep release review blocked and prepare only evidence, not release execution."
  },
  "boundaries": {
    "approves_release": "No",
    "executes_release": "No",
