...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R-001` | AGENTS.md |  | Workflow Rules | Codex should follow the old task checklist. | `WORKFLOW_RULE` | old workflow source | replace after reviewed plan and approval | replace | Old workflow guidance can move after approval. | workflow | replace with IntentOS workflow rule through apply-plan | Yes | HIGH |
