...
| Field | Value |
| --- | --- |
| Plain user summary | I found a release channel with possible cost or retention impact. A release/cost owner must decide before release review. |
...
| Field | Value |
| --- | --- |
| Identity type | local_bundle |
| Identity ref | artifact:release.zip |
| Digest or ID | sha256:abc |
...
```json
{
  ...
  "release_channel_policy_digest": "sha256:5d421793d60dfaf42e10be75645d07d7023d815c786d75e3a1d28f48e85e3d72",
  ...
  "release_package_identity": {
    "identity_type": "source_archive",
    "identity_ref": "artifact:release.zip",
    "digest_or_id": "sha256:abc",
  ...
  "decision": {
    ...
    "plain_user_summary": "I found a release channel with possible cost or retention impact. A release/cost owner must decide before release review."
  },
  "boundaries": {
    "approves_release": "No",
    "executes_release": "No",
