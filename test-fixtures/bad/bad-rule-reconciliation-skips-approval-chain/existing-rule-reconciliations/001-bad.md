...
| --- | --- | --- | --- | --- | --- | --- |
| `RR-001` | `ENGINEERING_BASELINE` | `engineering:folder-structure` | `standard-baseline:web` | `MERGE` | Yes | update AGENTS directly |
...
```json
{
  ...
  "reconciliation_items": [
    {
      "item_id": "RR-001",
      "existing_rule_ref": "engineering:folder-structure",
      ...
      "outcome": "MERGE",
      "reason": "Bad fixture: merge skips apply chain.",
      "merge_reason": "",
      "preserved_existing_terms": [],
      "added_intentos_terms": [],
      "risk_surfaces": ["engineering"],
      "human_decision_required": "Yes",
      "requires_apply_chain": "No",
      "can_replace_existing_rule": "No",
      "target_action": "update AGENTS directly"
    }
  ],
  "protected_constraints": [],
  "release_production_gaps": [],
  "conflicts": [],
  "proposed_next_steps": ["Unified Apply Plan"],
  "boundary": {
