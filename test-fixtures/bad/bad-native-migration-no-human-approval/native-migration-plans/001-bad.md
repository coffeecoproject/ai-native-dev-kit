...
| Requires Human Approval Before Apply | `No` |
...
| Field | Value |
| --- | --- |
| Backup path | `.ai-native/backups/native-migration/bad/AGENTS.md` |
...
- This plan requires human approval before governance replacement: No
