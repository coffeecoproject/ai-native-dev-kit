...
```json
{
  ...
  "intent_lock": {
    "user_intent": "Update expected file.",
    "normalized_intent": "Update expected file only.",
    "in_scope": [
      "code"
    ],
    "out_of_scope": []
  ...
  "execution_plan": {
    "plan_ref": "tasks/path.md",
    "planned_target_paths": [
      "src/expected.ts"
    ],
    "risk_classification": "NORMAL",
    "approval_refs": [],
    "restore_strategy": "Revert planned file."
  },
  "actual_diff": {
    "diff_source": "git",
    "changed_files": [
  ...
  "intent_digest": "sha256:5d4f68018cafca15a8b23da8c6faa912e0d1f5a8f2108a7886ae459c38ba113c"
}
```
