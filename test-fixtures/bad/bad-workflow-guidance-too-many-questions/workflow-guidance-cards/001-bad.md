...
Recommended next step: Prepare a read-only plan.

Can AI continue now: limited

What I need from you: Too many questions are listed below.
...
|---|---|---|
| Goal clarity | unclear | user goal |
...
| High-risk scope clear | unknown | scope confirmation |
