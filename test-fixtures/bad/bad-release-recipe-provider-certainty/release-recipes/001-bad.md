# Bad Release Recipe: Provider Certainty

## Human Summary

| Field | Value |
|---|---|
| Recipe ID | `bad-provider-certainty` |
...
| Signal | Evidence |
|---|---|
| frontend app | `package.json`; this project must be Vercel |
...
| environment reference | preview reference |
