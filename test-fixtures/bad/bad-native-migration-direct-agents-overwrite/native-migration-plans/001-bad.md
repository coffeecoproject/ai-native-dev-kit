...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R-001` | `AGENTS.md` | line 3: Old Codex workflow note. | `WORKFLOW_RULE` | old agent rule | replace after reviewed plan and approval | replace | Workflow rule can move to IntentOS. | workflow | replace with IntentOS rule | Yes |
...
| --- | --- | --- | --- | --- | --- |
| 1 | directly rewrites AGENTS.md now | `AGENTS.md` | No | Yes | Proposed |
