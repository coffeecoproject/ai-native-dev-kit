...
| Field | Value |
| --- | --- |
| Execution Kind | `CONTROLLED_PATCH` |
...
| Field | Value |
| --- | --- |
| Patch State | `CONTROLLED_PATCH` |
| Reason | controlled patch but no debt handoff |
...
```json
{
  ...
  "execution_kind": "CONTROLLED_PATCH",
