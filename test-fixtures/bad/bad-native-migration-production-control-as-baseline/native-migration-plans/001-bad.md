...
| --- | --- | --- |
| Release / rollback | docs/release.md | preserve and map |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R-001` | docs/release.md | line 2: production deploy and rollback owner must approve provider release | `ENGINEERING_BASELINE` | project baseline | migrate into IntentOS baseline after review | map | Treat production release as baseline | engineering | map to engineering/environment baseline | Yes |

## Conflicts And Decisions

| Conflict ID | Conflict Type | Existing Source | IntentOS Target | Default Decision | Human Decision Required |
| --- | --- | --- | --- | --- | --- |
| C-001 | `PRODUCTION_CONFLICT` | docs/release.md | Release Guide / Recipe / Handoff mapping | Preserve SOP and map only | Yes |
...
| --- | --- | --- |
| Confirm release owner | release owner | Needed before apply |
