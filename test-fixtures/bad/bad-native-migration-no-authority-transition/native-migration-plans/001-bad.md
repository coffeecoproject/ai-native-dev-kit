...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R-001` | AGENTS.md | line 2: Codex must follow project review flow | `WORKFLOW_RULE` | old workflow source | replace after reviewed plan and approval | replace | Old AI workflow guidance can move under IntentOS workflow authority after approval | workflow | replace with IntentOS workflow rule through apply-plan | Yes |
