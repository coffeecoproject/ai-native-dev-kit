...
This bad report claims automatic continuation for a CI environment failure
without retry-policy proof or production side-effect proof.

## Human Summary

| Field | Value |
| --- | --- |
| Plain user summary | The remote check failed for an environment or provider reason. |
| Plain next step | Retry the check. |
| Operation | `ci` |
...
```json
{
  ...
  "runtime_hygiene_digest": "sha256:3a73842958793c70021fd99ec13474def394eba474690775a7ed738e90891ae8",
