...
| --- | --- | --- | --- | --- | --- |
| audit | Old history | Rewritten IntentOS history | `MAP_TO_INTENTOS_ARTIFACT` | `Yes` | `Yes` |
...
Rewrite old history to look IntentOS-native.
...
- This report rewrites history: Yes
