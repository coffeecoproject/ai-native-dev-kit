# Approval Record: bad symlink path
...
|---|---|---|---|---|
| A001 | WORKFLOW_ASSET_UPDATE | `symlink:docs/current.md` | Yes | bad symlink target |

## Approval Scope

| Field | Value |
|---|---|
| Included target paths | `symlink:docs/current.md` |
...
Project owner approves A001 for `symlink:docs/current.md` only.
