# Approval Record: bad mismatched action ID
...
| Plan hash | `sha256:6666666666666666666666666666666666666666666666666666666666666666` |

## Approved Action IDs

| Action ID | Action type | Target paths | Approved? | Notes |
|---|---|---|---|---|
| A001 | WORKFLOW_ASSET_UPDATE | `.ai-native/version.json` | Yes | table says A001 |
...
Project owner approves A002 for `.ai-native/version.json` only.
