# Approval Record: bad wildcard path
...
| Plan hash | `sha256:1111111111111111111111111111111111111111111111111111111111111111` |

## Approved Action IDs

| Action ID | Action type | Target paths | Approved? | Notes |
|---|---|---|---|---|
| A001 | WORKFLOW_ASSET_UPDATE | `docs/*.md` | Yes | bad wildcard path |

## Approval Scope

| Field | Value |
|---|---|
| Included target paths | `docs/*.md` |
...
Project owner approves A001 for `docs/*.md` only.
