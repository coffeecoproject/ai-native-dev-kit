...
| Safe Next Step | Trace controls execution. |

## Release Decision View

| Decision | Status | Reason | Next Step |
|---|---|---|---|
| Final release-plan state | `READY_FOR_HANDOFF_REVIEW` | Trace controls execution. | Proceed. |

## Release Plan Trace

| Source System | Status | Ref | Contribution | Control Authority |
|---|---|---|---|---|
| Release Guide | `PASS` | N/A | Trace controls execution. | Yes |
...
|---|---|---|---|---|
| Release Guide | `SOURCE_SYSTEM` | `PASS` | N/A | Trace controls execution. |
...
| Action | Condition |
|---|---|
| Execute from trace | Trace controls execution. |

## Human Must Decide

| Decision | Why | Next Step |
|---|---|---|
| None | Trace controls execution. | Proceed. |
...
- This plan lets trace control execution: Yes
