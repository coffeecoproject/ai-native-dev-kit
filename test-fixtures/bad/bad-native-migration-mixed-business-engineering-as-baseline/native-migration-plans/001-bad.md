...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `R-001` | AGENTS.md | 5-5 | Project Agent Rules > Business Rules | Customer invoice status schema must preserve tax meaning. | `ENGINEERING_BASELINE` | project baseline | migrate into IntentOS baseline after review | map | Treats invoice tax meaning as schema style only. | engineering | map to engineering/environment baseline | Yes | HIGH |
  ...
  "rule_classifications": [
    {
      ...
      "source_start_line": 5,
      "source_end_line": 5,
      "context_heading": "Project Agent Rules > Business Rules",
      ...
      "reason": "Treats invoice tax meaning as schema style only.",
