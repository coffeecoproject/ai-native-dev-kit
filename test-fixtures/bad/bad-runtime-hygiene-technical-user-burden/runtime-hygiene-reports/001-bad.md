...
| Field | Value |
| --- | --- |
| Plain user summary | ahead/behind and merge base show sha256 mismatch; run git rev-list before deciding |
| Plain next step | Keep the task open and repair the blocker. |
| Operation | `push` |
| Runtime class | `PRE_PUSH_GATE_FAILED` |
...
```json
{
  ...
  "runtime_hygiene_digest": "sha256:f5f7c1c0c98607f205ff8e14314f38e7fe73bf7fea1f98e26e0f93b1f6fdc9a0",
  "task_ref": "task:bad",
  ...
  "plain_user_summary": "ahead/behind and merge base show sha256 mismatch; run git rev-list before deciding",
