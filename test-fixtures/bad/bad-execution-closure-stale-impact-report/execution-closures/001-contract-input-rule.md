...
| Field | Value |
|---|---|
| Task / change | Invoice due-date validation |
| Related task card | `tasks/999-invoice-due-date-rule.md` |
| User intent | Add an invoice due-date restriction that rejects expired due dates. |
