...
```json
{
  ...
  "completion_gate_digest": "sha256:5792962a3211907c82c603eee216900852209893a1b8efe0d1cd53f9331a2600",
  ...
  "source_chain": [
    ...
    },
    {
      ...
      "task_ref": "tasks/999-old-task.md",
  ...
  "task_consistency": {
    ...
    "recorded_task_refs": [
      ...
      "test_evidence:tasks/999-old-task.md",
      "execution_assurance:tasks/001-appointment-requests-must-include-a-service-time.md"
    ],
    "all_sources_same_task": "No",
    "reason": "Mismatched task refs: test_evidence=tasks/999-old-task.md"
  },
