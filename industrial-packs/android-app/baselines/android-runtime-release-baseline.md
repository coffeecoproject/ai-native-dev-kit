# Android Runtime And Release Baseline

## Required Coverage

- supported SDK versions and device classes are identified
- critical flows are verified on emulator or device
- loading, empty, error, denied, offline, degraded network, and background states are covered
...
- release notes, rollback or staged-release plan, and monitoring evidence exist
