...
- For user-facing baseline decisions, run `node scripts/cli.mjs baseline-decision .` first and create a Baseline Decision Card when BL level, platform packs, industrial candidates, or write boundaries affect the task.
