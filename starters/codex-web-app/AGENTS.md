...
6. Auth, permission, migration, production config, secrets, high-risk, and security-sensitive work requires stricter internal planning, testing, review, evidence, and rollback. Ask the user only for missing business facts or consent to a concrete real-world effect.
...
- L3: irreversible, regulated, value-transfer, production migration, destructive operation, regulated data, secrets, production config; full internal workflow, with exact user consent only for the prepared real-world effect.
