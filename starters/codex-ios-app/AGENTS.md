...
6. Auth, permission, persistence migration, production config, secrets, entitlements, signing, Keychain, and security-sensitive work requires stricter internal planning, testing, review, evidence, and rollback. Ask the user only for missing business facts or consent to a concrete real-world effect.
