...
6. Do not modify auth, permission, persistence migration, production config, secrets, signing, manifest exported components, or security-sensitive logic without a risk report and explicit approval.
...
- L3: signing, keystore, Play Console release, sensitive permissions, destructive migration, value-transfer, regulated data, production config, bundle/APK upload; full workflow and explicit human approval.
