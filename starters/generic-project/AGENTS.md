...
- L3: irreversible, regulated, production, security, value-transfer, identity, destructive data, secret, infrastructure, or safety-critical change; full internal workflow, with exact user consent only for the prepared real-world effect.
