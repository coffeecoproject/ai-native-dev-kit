...
| `PERMISSION_RISK` | `NOT_STARTED` | Not started | Pre-execution report. |
| `RELEASE_IMPACT` | `NOT_STARTED` | Not started | Pre-execution report. |
| `BACKGROUND_WORK` | `NOT_STARTED` | Not started | Pre-execution report. |
| `EXTERNAL_INTEGRATION` | `NOT_STARTED` | Not started | Pre-execution report. |
...
| `PERMISSION_RISK` | Confirm surface-specific evidence after implementation. | Not started | `NOT_STARTED` |
...
| `EXTERNAL_INTEGRATION` | Confirm surface-specific evidence after implementation. | Not started | `NOT_STARTED` |
