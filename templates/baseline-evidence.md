...
- `Evidence Ref` must point to a project file when `Status` is `Done`.
- `Reason if skipped` is required when `Status` is `Not applicable`.
- Use project-relative paths such as `evals/<file>.md`, `releases/<file>.md`, `ai-logs/<file>.md`, or `docs/<file>.md`.

## Production Readiness

Status: PASS / CONDITIONAL_PASS / FAIL / NOT_AUDITED / NOT_APPLICABLE
