...
- Runtime Plan digest: `sha256:8b2942e266a3f4ab543495e8077b4a9e9fe46f19ff241c6ba432a74dbe15f6fd`
...
| `self-current-syntax` | `VERIFY` | `COMMAND` | `npm run verify:syntax` |
| `self-current-consumer-syntax` | `VERIFY` | `COMMAND` | `npm run verify:consumer-syntax` |
| `self-current-runtime-trust-core` | `VERIFY` | `COMMAND` | `npm run verify:runtime-trust:core` |
| `self-current-evidence-retention` | `VERIFY` | `COMMAND` | `npm run verify:evidence-retention` |
| `self-current-governance-core` | `VERIFY` | `COMMAND` | `node --test tests/control-effectiveness.test.mjs tests/understanding-planning-closure.test.mjs tests/business-universe-coverage.test.mjs tests/manifest-authority.test.mjs` |
| `self-current-operating-core` | `VERIFY` | `COMMAND` | `node --test tests/operating-model.test.mjs tests/operating-entry-trust.test.mjs tests/review-context-authority.test.mjs tests/active-guidance-distribution-closeout.test.mjs` |
| `self-current-distribution-trust` | `VERIFY` | `COMMAND` | `node --test tests/execution-distribution-trust.test.mjs` |
| `self-current-release-topology-consumer` | `VERIFY` | `COMMAND` | `node --test tests/release-topology-consumer.test.mjs` |
| `self-current-obligation-evidence` | `VERIFY` | `COMMAND` | `node --test tests/119-operating-loop-governance-obligations.test.mjs` |
...
- Run workspace: `.intentos/runtime-runs/vrun-119-resolve-operating-loop-modularity-r49`
- Broad cleanup: `No`
...
```json
{
  ...
  "declaration_source": {
    ...
    "digest": "sha256:d0d4c769beaf83bb75be0d03b0acf9c7364ad1a627dbbd226091b48d79ab49be",
  ...
  "actions": [
    {
      ...
      "timeout_ms": 15000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-119-resolve-operating-loop-modularity-r49/outputs/self-runtime-service.log",
      "obligation_ids": [],
      "positive_path": "No",
      "negative_path": "No",
      "resource_ids": [
    ...
    },
    {
      ...
      "timeout_ms": 15000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-119-resolve-operating-loop-modularity-r49/outputs/self-runtime-negative.log",
      "obligation_ids": [],
      "positive_path": "No",
      "negative_path": "Yes",
      "resource_ids": [
    ...
    },
    {
      ...
      "timeout_ms": 15000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-119-resolve-operating-loop-modularity-r49/outputs/self-runtime-positive.log",
      "obligation_ids": [],
      "positive_path": "Yes",
      "negative_path": "No",
      "resource_ids": [
    ...
    },
    {
      ...
      "timeout_ms": 1800000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-119-resolve-operating-loop-modularity-r49/outputs/self-current-syntax.log",
      "obligation_ids": [],
      "positive_path": "Yes",
      "negative_path": "Yes",
      "resource_ids": [
    ...
    },
    {
      ...
      "argv": [
        "npm",
        "run",
        "verify:consumer-syntax"
      ],
      "cwd": ".",
      "timeout_ms": 1800000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-119-resolve-operating-loop-modularity-r49/outputs/self-current-consumer-syntax.log",
      "obligation_ids": [],
      "positive_path": "Yes",
      "negative_path": "Yes",
      "resource_ids": [
    ...
    },
    {
      ...
      "argv": [
        "npm",
        "run",
        "verify:runtime-trust:core"
      ],
      "cwd": ".",
      "timeout_ms": 1800000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-119-resolve-operating-loop-modularity-r49/outputs/self-current-runtime-trust-core.log",
      "obligation_ids": [],
      "positive_path": "Yes",
      "negative_path": "Yes",
      "resource_ids": [
    ...
    },
    {
      ...
      "timeout_ms": 1800000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-119-resolve-operating-loop-modularity-r49/outputs/self-current-evidence-retention.log",
      "obligation_ids": [],
      "positive_path": "Yes",
      "negative_path": "Yes",
      "resource_ids": [
      ...
      "external_effect": "No",
      "depends_on": [
        "self-current-runtime-trust-core"
      ]
    },
    {
      ...
      "timeout_ms": 1800000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-119-resolve-operating-loop-modularity-r49/outputs/self-current-governance-core.log",
      "obligation_ids": [],
      "positive_path": "Yes",
      "negative_path": "Yes",
      "resource_ids": [
      ...
      "external_effect": "No",
      "depends_on": [
        "self-current-evidence-retention"
      ]
    },
    {
      ...
      "timeout_ms": 1800000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-119-resolve-operating-loop-modularity-r49/outputs/self-current-operating-core.log",
      "obligation_ids": [],
      "positive_path": "Yes",
      "negative_path": "Yes",
      "resource_ids": [
    ...
    },
    {
      ...
      "timeout_ms": 1800000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-119-resolve-operating-loop-modularity-r49/outputs/self-current-distribution-trust.log",
      "obligation_ids": [],
      "positive_path": "Yes",
      "negative_path": "Yes",
      "resource_ids": [
    ...
    },
    {
      ...
      "timeout_ms": 1800000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-119-resolve-operating-loop-modularity-r49/outputs/self-current-release-topology-consumer.log",
      "obligation_ids": [],
      "positive_path": "Yes",
      "negative_path": "Yes",
      "resource_ids": [
      ...
      "external_effect": "No",
      "depends_on": [
        "self-current-distribution-trust"
      ]
    },
    {
      ...
      "timeout_ms": 1800000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-119-resolve-operating-loop-modularity-r49/outputs/self-current-obligation-evidence.log",
      "obligation_ids": [
      ...
      "external_effect": "No",
      "depends_on": [
        "self-current-release-topology-consumer"
      ]
    },
    {
      ...
      "timeout_ms": 60000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-119-resolve-operating-loop-modularity-r49/outputs/self-current-runtime-behavior.log",
      "obligation_ids": [
  ...
  "run_workspace": ".intentos/runtime-runs/vrun-119-resolve-operating-loop-modularity-r49",
  "authority_binding": {
    ...
    "sources": [
      ...
      },
      {
        ...
        "raw_file_digest": "sha256:d0d4c769beaf83bb75be0d03b0acf9c7364ad1a627dbbd226091b48d79ab49be"
      }
    ]
  },
  "boundaries": {
