...
- Runtime Plan digest: `sha256:837fd0c0cb2419f3c88758ab581cacd8cc6fb0b0003660258814614d3804ec2d`
...
| `self-current-obligation-evidence` | `VERIFY` | `COMMAND` | `node --test tests/evidence-retention.test.mjs tests/118-evidence-retention-governance-obligations.test.mjs` |
...
- Run workspace: `.intentos/runtime-runs/vrun-118-evidence-retention-deduplication-r3`
- Broad cleanup: `No`
...
```json
{
  ...
  "lifecycle_plan_ref": "verification-runtime-lifecycle-plans/118-evidence-retention-deduplication.md",
  ...
  "declaration_source": {
    ...
    "digest": "sha256:d5b571da5208632e15b9cbf9ef8ae5bb5c9f2c8aa2672af53fe74835cbc911b5",
  ...
  "actions": [
    {
      ...
      "timeout_ms": 15000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-118-evidence-retention-deduplication-r3/outputs/self-runtime-service.log",
      "obligation_ids": [],
      "positive_path": "No",
      "negative_path": "No",
      "resource_ids": [
    ...
    },
    {
      ...
      "timeout_ms": 15000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-118-evidence-retention-deduplication-r3/outputs/self-runtime-negative.log",
      "obligation_ids": [],
      "positive_path": "No",
      "negative_path": "Yes",
      "resource_ids": [
    ...
    },
    {
      ...
      "timeout_ms": 15000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-118-evidence-retention-deduplication-r3/outputs/self-runtime-positive.log",
      "obligation_ids": [],
      "positive_path": "Yes",
      "negative_path": "No",
      "resource_ids": [
    ...
    },
    {
      ...
      "timeout_ms": 1800000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-118-evidence-retention-deduplication-r3/outputs/self-current-candidate-verification.log",
      "obligation_ids": [],
      "positive_path": "Yes",
      "negative_path": "Yes",
      "resource_ids": [
    ...
    },
    {
      ...
      "timeout_ms": 1800000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-118-evidence-retention-deduplication-r3/outputs/self-current-obligation-evidence.log",
      "obligation_ids": [
    ...
    },
    {
      ...
      "timeout_ms": 60000,
      "environment": [],
      "output_ref": "file:.intentos/runtime-runs/vrun-118-evidence-retention-deduplication-r3/outputs/self-current-runtime-behavior.log",
      "obligation_ids": [
  ...
  "run_workspace": ".intentos/runtime-runs/vrun-118-evidence-retention-deduplication-r3",
  "authority_binding": {
    ...
    "sources": [
      ...
      },
      {
        ...
        "raw_file_digest": "sha256:d5b571da5208632e15b9cbf9ef8ae5bb5c9f2c8aa2672af53fe74835cbc911b5"
      }
    ]
  },
  "boundaries": {
