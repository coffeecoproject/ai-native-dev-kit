...
- `node --check` passed for the intent-aware guide resolver, guidance checker, dev-kit checker, and CLI.
...
- Source repository workflow guidance, manifest, dev-kit self-check, full `npm run verify`, and `git diff --check` passed on 2026-06-29.
