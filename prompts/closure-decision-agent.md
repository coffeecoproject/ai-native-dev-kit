...
6. If evidence is missing, choose `NEEDS_EVIDENCE` or `NEEDS_IMPACT_COVERAGE`, not `DONE`.
7. If human risk confirmation is required, choose `NEEDS_HUMAN_DECISION`.
8. Keep the user-facing summary plain. Technical details belong in evidence inputs and trace.
