...
```json
{
  ...
  "task_ref": "tasks/001-mini-program-review.md",
  ...
  "gate_checks": [],
  "task_consistency": {
    "expected_task_ref": "tasks/001-mini-program-review.md",
    "recorded_task_refs": ["tasks/001-mini-program-review.md"],
  ...
  "next_step": "Use Release Evidence Gate for mini-program review handoff."
}
```
