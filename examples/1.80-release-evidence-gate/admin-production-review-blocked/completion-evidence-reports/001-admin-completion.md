...
```json
{
  ...
  "completion_evidence_ref": "artifact:completion-evidence-reports/001-admin-completion.md",
  ...
  "gate_checks": [],
  "task_consistency": {
    "expected_task_ref": "tasks/001-admin-release.md",
    "recorded_task_refs": ["tasks/001-admin-release.md"],
  ...
  "next_step": "Use Release Evidence Gate for blocked production-review evidence."
}
```
