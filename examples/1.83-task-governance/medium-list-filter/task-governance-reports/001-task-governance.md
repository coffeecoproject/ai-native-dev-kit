...
| Triggered surfaces | local frontend interaction, list filter display |
...
```json
{
  ...
  "impact_classification": {
    ...
    "trigger_evidence": [
      ...
      "Intent matched bounded behavior signal: list filter display"
    ],
  ...
  "source_chain": [
    {
      ...
      "digest": "sha256:e74c7f22218461cea0a363874a6d7eeb58d4f3cc3df91630f30300c128ab9956",
      "state": "MEDIUM",
