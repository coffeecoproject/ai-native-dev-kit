...
| Effective release channel | provider_direct_deploy |
...
| Cost owner ref | artifact:docs/release-sop.md |

## Release Package Identity

| Field | Value |
| --- | --- |
| Identity type | provider_build_id |
| Identity ref | external:provider-build |
| Digest or ID | build-2026-07-09-001 |
| Package location | external_provider |
...
| Release owner ref | artifact:docs/release-sop.md |
| Cost owner ref | artifact:docs/release-sop.md |
| Platform owner ref | artifact:docs/release-sop.md |
| Production owner ref | artifact:docs/release-sop.md |
...
```json
{
  ...
  "release_channel_policy_ref": "release-channel-policies/001-provider-sop.md",
  "release_channel_policy_digest": "sha256:c0dfaaff218dbfffcdedb4a64d3a07cf1c9e6628f98f25742bb8e418e8798199",
  ...
  "effective_release_channel": {
    "channel": "provider_direct_deploy",
    ...
    "recommended_channel_summary": "provider_direct_deploy with recommendation KEEP_EXISTING_APPROVED_CHANNEL."
  },
  ...
  "github_actions_billing_profile": {
    ...
    "cost_owner_ref": "artifact:docs/release-sop.md"
  },
  "cost_risk": {
  ...
  "owners": {
    ...
    "release_owner_ref": "artifact:docs/release-sop.md",
    "cost_owner_ref": "artifact:docs/release-sop.md",
    "platform_owner_ref": "artifact:docs/release-sop.md",
    "production_owner_ref": "artifact:docs/release-sop.md"
  },
  "release_package_identity": {
    "identity_type": "provider_build_id",
    "identity_ref": "external:provider-build",
    "digest_or_id": "build-2026-07-09-001",
    "not_applicable_reason": "N/A"
  },
  "artifact_policy": {
    "release_package_location": "external_provider",
