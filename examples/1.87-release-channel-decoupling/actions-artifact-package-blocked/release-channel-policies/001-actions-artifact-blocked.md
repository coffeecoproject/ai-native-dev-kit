...
| Field | Value |
| --- | --- |
| Plain user summary | I found release-channel gaps (missing_release_package_identity). I will keep release review blocked and prepare only evidence, not release execution. |
| Project type | existing_project |
| Effective release channel | github_actions_artifact |
| Recommendation | RECOMMEND_DECOUPLING_FROM_ACTIONS_ARTIFACT_PACKAGE |
| Blocked | Yes |
...
| Actions artifact used as release package | Yes |
| GitHub Packages used as release package | Unknown |
| Artifact retention policy ref | artifact:release-retention-policy.md |
| Policy state | SHORT_LIVED_HANDOFF_ONLY |
...
| Actions minutes risk | Yes |
| Artifact storage risk | Yes |
| Cache storage risk | Unknown |
| External provider cost risk | No |
| Registry storage cost risk | No |
| Platform fee risk | Unknown |
| Cost owner required | Yes |
| Cost owner ref | human-decision:cost-owner-review |
...
| Release owner ref | human-decision:release-owner-review |
| Cost owner ref | human-decision:cost-owner-review |
...
```json
{
  ...
  "release_channel_policy_ref": "release-channel-policies/001-actions-artifact-blocked.md",
  "release_channel_policy_digest": "sha256:25f0e49133be4c3a96f59fefc73ce701e800bbec245a1efbb7e7995e5b230086",
  ...
  "effective_release_channel": {
    "channel": "github_actions_artifact",
    "recommendation_class": "RECOMMEND_DECOUPLING_FROM_ACTIONS_ARTIFACT_PACKAGE",
    "blocked": "Yes",
    "blocked_by": [
    ...
    "recommended_channel_summary": "github_actions_artifact with recommendation RECOMMEND_DECOUPLING_FROM_ACTIONS_ARTIFACT_PACKAGE."
  },
  ...
  "github_actions_policy": {
    ...
    "actions_artifact_used_as_release_package": "Yes",
    "github_packages_used_as_release_package": "Unknown",
    "artifact_retention_policy_ref": "artifact:release-retention-policy.md",
    "policy_state": "SHORT_LIVED_HANDOFF_ONLY"
  },
  "github_actions_billing_profile": {
    "repository_visibility": "private",
    "runner_type": "github_hosted",
    "uses_larger_runner": "Unknown",
    "actions_minutes_cost_risk": "Yes",
    "artifact_storage_cost_risk": "Yes",
    "cache_storage_cost_risk": "Unknown",
    "cost_owner_ref": "human-decision:cost-owner-review"
  },
  "cost_risk": {
    "github_actions_minutes_risk": "Yes",
    "github_actions_artifact_storage_risk": "Yes",
    ...
    "app_store_or_platform_fee_risk": "Unknown",
    "cost_owner_required": "Yes",
    "cost_owner_ref": "human-decision:cost-owner-review"
  },
  "owners": {
    "release_owner_required": "Yes",
    "release_owner_ref": "human-decision:release-owner-review",
    "cost_owner_ref": "human-decision:cost-owner-review",
  ...
  "decision": {
    ...
    "plain_user_summary": "I found release-channel gaps (missing_release_package_identity). I will keep release review blocked and prepare only evidence, not release execution."
  },
  "boundaries": {
    "approves_release": "No",
    "executes_release": "No",
