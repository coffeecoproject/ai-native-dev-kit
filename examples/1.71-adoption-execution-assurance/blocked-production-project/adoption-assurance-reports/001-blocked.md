...
```json
{
  ...
  "surfaces": [
    ...
    },
    {
      ...
      "notes": "Release owner / rollback authority needs owner confirmation."
    },
    {
      "surface": "ci_hooks",
      "status": "PENDING_HUMAN_DECISION",
      "evidence": "checker:convergence",
      "notes": "CI and hook authority needs explicit decision before migration."
    },
    {
      "surface": "documents",
      "status": "MAPPED",
    ...
    },
    {
      ...
      "notes": "Read-only simulation passed, but authority remains blocked."
    }
  ],
  "evidence_refs": [
    "checker:workflow-next",
  ...
  "source_systems": {
    ...
    "governance_convergence": {
      ...
      "contribution": "release and CI/hook authority remain project-owned"
    },
    "release_plan": {
      "name": "release_plan",
      "status": "NEEDS_INPUT",
      "ref": "generated:release_plan",
      "contribution": "release owner decision is required"
    }
  },
  "simulation": {
