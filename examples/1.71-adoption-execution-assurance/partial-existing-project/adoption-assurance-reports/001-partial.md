...
```json
{
  ...
  "surfaces": [
    ...
    {"surface":"work_queue","status":"PENDING_APPLY","evidence":"checker:work-queue","notes":"Work queue artifact is not verified in the target project."},
  ...
  "pending_decisions": ["Verify work queue behavior.","Run read-only simulation before full adoption can be claimed."],
