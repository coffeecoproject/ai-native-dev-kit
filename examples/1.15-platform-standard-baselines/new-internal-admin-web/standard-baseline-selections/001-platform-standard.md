# Standard Baseline Selection Report: New Internal Admin Web
...
- Project state: new
- Project shape: internal admin web
- Risk level: medium
...
| Pack | Layer | Reason |
|---|---|---|
| backend-api-standard | standard | backend implementation is not confirmed |
