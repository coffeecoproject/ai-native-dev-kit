...
| --- | --- | --- | --- | --- |
| adoption_assurance | `RECORDED` | `artifact:adoption-assurance-reports/001-adoption.md` | Adoption execution verified. | Source system |
| governance_convergence | `RECORDED` | `artifact:governance-convergence-reports/001-convergence.md` | Governance surfaces mapped. | Source system |
...
```json
{
  ...
  "source_systems": [{"name":"adoption_assurance","status":"RECORDED","ref":"artifact:adoption-assurance-reports/001-adoption.md","contribution":"Adoption execution verified."},{"name":"governance_convergence","status":"RECORDED","ref":"artifact:governance-convergence-reports/001-convergence.md","contribution":"Governance surfaces mapped."}],
