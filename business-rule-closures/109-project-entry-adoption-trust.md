...
IntentOS project entry must reject invalid identity, guidance, authority, or evidence; controlled adoption writes must be atomic; activation must run from project-local assets; current work must remain preserved.
...
| Field | Value |
| --- | --- |
| Business Rule ID | `business-rule:intentos-project-entry-must-reject-invalid-identity-guidance-aut` |
| Business Rule Ref | `artifact:business-rule-closures/109-project-entry-adoption-trust.md` |
| Source Request Digest | `sha256:82fbf04d1c8004e5def93998b4fc6c976a2c6312f705d5d0f748e3e49d859f0d` |
| Business Rule Digest | `sha256:656a30ecfb1ea425e599bb9da5bf752ae2aeb766c89354599ca7bf8f6c64954b` |
| Closure Digest | `sha256:fc1ea708d281f448038b52e60a399b703ea5d299dfdfe1d7a36c423b1b34a5ed` |
...
| Coverage ref | `N/A` |
| Coverage digest | `N/A` |
| Coverage state | `NOT_REQUIRED_WITH_REASON` |
| Coverage scenarios | none |
| Coverage mapping status | `NOT_REQUIRED` |
...
| --- | --- | --- | --- |
| `ACTOR` | `CLOSED` | Affected actors are bound through current project evidence or a concrete not-required reason. | N/A |
| `TRIGGER_SCENARIO` | `CLOSED` | Trigger scenarios are bound through current project evidence or a concrete not-required reason. | N/A |
| `INPUT_CONDITION` | `CLOSED` | IntentOS project entry must reject invalid identity, guidance, authority, or evidence; controlled adoption writes must be atomic; activation must run from project-local assets; current work must remain preserved. | human-decision:rule-understanding |
...
| `DATA_BEHAVIOR` | `DEFAULTED_WITH_REASON` | Do not batch-change existing records unless the user explicitly consents to that irreversible data effect. | human-decision:rule-understanding, default:existing-records |
...
| `EXCEPTION_POLICY` | `DEFAULTED_WITH_REASON` | No bypass or exemption is assumed unless the user states the corresponding business exception. | human-decision:rule-understanding, default:no-implicit-exemptions |
...
| `AUDIT_LOGGING` | `CLOSED` | No audit-specific behavior is explicit. | human-decision:rule-understanding |
...
```json
{
  ...
  "user_request": "IntentOS project entry must reject invalid identity, guidance, authority, or evidence; controlled adoption writes must be atomic; activation must run from project-local assets; current work must remain preserved.",
  "source_request_digest": "sha256:82fbf04d1c8004e5def93998b4fc6c976a2c6312f705d5d0f748e3e49d859f0d",
  "business_rule_id": "business-rule:intentos-project-entry-must-reject-invalid-identity-guidance-aut",
  ...
  "closure_digest": "sha256:fc1ea708d281f448038b52e60a399b703ea5d299dfdfe1d7a36c423b1b34a5ed",
  ...
  "dimensions": [
    ...
    },
    {
      ...
      "status": "CLOSED",
      "summary": "IntentOS project entry must reject invalid identity, guidance, authority, or evidence; controlled adoption writes must be atomic; activation must run from project-local assets; current work must remain preserved.",
      "evidence_refs": [
