...
- if the user asks to configure, apply, initialize, inject, install, or bootstrap the IntentOS workflow, treat it as execution bootstrap intent
...
- use `.intentos/prompts/bootstrap-agent.md` when present
...
- explain the recommended path in plain language and keep the user responsible only for confirmation, judgment, and risk acceptance
...
- before first non-trivial implementation, use `.intentos/prompts/project-onboarding-agent.md`
...
- read `.intentos/core/goal-mode.md` and `.intentos/prompts/goal-planner-agent.md` when present
...
- read `.intentos/core/subagent-orchestration.md` when helper agents are used for planning, read-only research, review, repair analysis, or reporting
...
- use `.intentos/core/glossary.md` when internal workflow terms need translation
...
- use `.intentos/templates/skill-candidate.md`
- review with `.intentos/checklists/skill-review.md`
...
- use `.intentos/templates/project-automation-proposal.md`
- review with `.intentos/checklists/automation-review.md`
...
- `ACTION_REQUIRED` means a retro, improvement, Skill candidate, automation proposal, or intentos proposal may be needed
