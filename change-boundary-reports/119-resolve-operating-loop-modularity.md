...
The candidate is limited to a behavior-preserving split of `scripts/resolve-operating-loop.mjs`, generated-project distribution wiring, compatibility corrections found by verification, task-specific tests, fail-visible cleanup of distribution-trust temporary fixtures, governance and independent-review artifacts, and one sole final trusted runtime. Temporary cleanup is restricted to registered direct-child `intentos-*` roots created by the test itself. No product capability, production release, external operation, commit, push, broad temporary-directory cleanup, or independent draft is included.
...
| schemas/artifacts/execution-assurance.schema.json | M | Yes | Exact staged 1.119 candidate. |
...
| scripts/check-release-execution-topology.mjs | M | Yes | Exact staged 1.119 candidate. |
...
| scripts/lib/artifact-schema.mjs | M | Yes | Exact staged 1.119 candidate. |
...
| scripts/lib/execution-assurance-consumer.mjs | M | Yes | Exact staged 1.119 candidate. |
...
| tests/current-trust-fixture.test.mjs | M | Yes | Exact staged 1.119 candidate. |
...
| tests/release-execution-topology.test.mjs | M | Yes | Exact staged 1.119 candidate. |
| tests/release-trust-boundary.test.mjs | M | Yes | Exact staged 1.119 candidate. |
